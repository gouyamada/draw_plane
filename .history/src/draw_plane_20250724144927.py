# pylint: disable=too-many-arguments,too-many-positional-arguments,line-too-long,too-many-locals
"""
平面を描画するスクリプト
"""
import numpy as np
...
from mpl_toolkits.mplot3d import Axes3D  # 3Dプロット用に追加
...
def interactive_plane_visualizer():
    ...
    # 明示的にAxes3D型にキャスト（冗長だがIDEや型チェックの警告回避のため）
    ax: Axes3D = ax
    ...
    def update(val):
        ...
        point = ax.scatter(x0, y0, zs=z0, color='black', s=50)
